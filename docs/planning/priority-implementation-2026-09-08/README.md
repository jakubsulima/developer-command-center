...
- 07 — **lokalnie gotowy, staging oczekuje** — [raport 07](../../testing/priority-2026-09-08/07-report.md)
...
6. Kontrole wymagane przez projekt: `pnpm lint`, `pnpm typecheck`, `pnpm test` i `VITE_DATA_BACKEND=demo pnpm build`. Najpierw testy celowane, potem końcowe kontrole. Przed uruchomieniem sprawdź bieżące skrypty. Dokumentuj istniejące, niezwiązane błędy.
