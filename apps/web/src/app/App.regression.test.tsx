...
describe("regresje nowego modelu Celów", () => {
  ...
  it("układa krok na kolejny tydzień i zapisuje wybrany Cel w Podsumowaniu", async () => {
    ...
    await user.click(screen.getByText("Wybierz Cele"));
  ...
  it("edytuje Działanie, zmienia stan Celu i wiąże materiał z Działaniem", async () => {
    ...
    expect(within(statusDialog).getByLabelText("Co blokuje to Działanie?")).toBeInTheDocument();
    await user.click(within(statusDialog).getByRole("button", { name: "Zamknij okno" }));
