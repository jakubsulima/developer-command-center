...
import { Archive, ArrowRight, BookOpen, ChevronDown, FileText, Flag, FolderKanban, History, Lightbulb, ListChecks, MoreHorizontal, Pencil, Plus, RotateCcw, Trash2 } from "lucide-react";
...
export function ProjectDetailPage() {
  ...
  const openProjectEditor = () => { setProjectForm({ name: project.name, description: project.description ?? "" }); setDialog("edit"); };
  ...
  return <AppShell>
    ...
    <div className="project-detail-head persistent-project-head">
      ...
      <details className="project-more-menu"><summary aria-label="Opcje Projektu" title="Opcje Projektu"><MoreHorizontal /><span className="sr-only">Opcje Projektu</span></summary><div><Button onClick={(event) => { closeProjectMenu(event.currentTarget); openProjectEditor(); }}><Pencil />Edytuj Projekt</Button></div></details>
    </div>
